...
- `packages/@gotomts/core`: Core React components
- `packages/@gotomts/utils`: Shared React utilities
- `packages/@gotomts/tsconfig`: Shared `tsconfig.json`s used throughout the Turborepo
- `packages/@gotomts/eslint-config-acme`: ESLint preset
...
- Support using module path aliases like `@gotomts-core` for imports
- Write MDX for component documentation pages

For example, here's the included Story for our `Button` component:

```js:apps/docs/stories/button.stories.mdx
import { Button } from '@gotomts-core/src';
